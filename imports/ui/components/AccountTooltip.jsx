...
export default class AccountTooltip extends Account{
    ...
    renderDetailTooltip() {
        ...
        let isActive = validator.status == 2 + Meteor.settings.validatorStatus0 && !validator.jailed;
        ...
        <Col xs={6}>{(validator.status < 1 + Meteor.settings.validatorStatus0)?<Badge color="secondary">Unbonded</Badge>:<Badge color="warning">Unbonding</Badge>}</Col>
